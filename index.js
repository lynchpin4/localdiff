...
.default('dbpath', path.join(process.cwd(), 'db'))
.default('storage', path.join(process.cwd(), 'storage'))
...
var DB_DIR = argv.dbpath || path.join(process.cwd(), 'db');
var STORAGE_DIR = argv.storage;
